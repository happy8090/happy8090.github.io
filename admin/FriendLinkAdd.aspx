<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="FriendLinkAdd.aspx.cs" Inherits="WangQi.ERP.Web.admin.FriendLinkAdd" Title="无标题页" %>
      ...
      <tr>
        ...
        <tr>
            <td align="right" bgcolor="#ffffff">
                网站地址:</td>
            <td bgcolor="#ffffff">
                <asp:TextBox ID="Url" CssClass="adminput" runat="server">http://</asp:TextBox>
      ...
      <tr id="tr1">
        ...
        <tr id="tr2" class="hide">
            ...
            <td bgcolor="#ffffff">
                ...
                <asp:CustomValidator CssClass="adminpur" ID="LogoCustomValidator" runat="server"
                    Display="Dynamic" ErrorMessage="Logo文件格式错误" OnServerValidate="LogoCustomValidator_ServerValidate"></asp:CustomValidator></td>
        </tr>
        <tr>
            <td align="right" bgcolor="#ffffff">
                网站描述:</td>
            <td bgcolor="#ffffff">
                <asp:TextBox ID="friendLinkDescribe" runat="server" CssClass="adminbox" Rows="3" TextMode="MultiLine"></asp:TextBox></td>
        </tr>
      <tr>
        <td align="right" bgcolor="#FFFFFF"></td>
        <td bgcolor="#FFFFFF" style="height: 20px">&nbsp;<asp:Button ID="Add" runat="server" Text="添加链接" CssClass="inputBt" OnClick="Add_Click"  /></td>
      </tr>
    </table>
  </div>
