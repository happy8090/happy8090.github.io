<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true"  ValidateRequest ="false" CodeBehind="PaymentEdit.aspx.cs" Inherits="WangQi.ERP.Web.admin.PaymentEdit" Title="无标题页" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7">
      ...
      <tr>
            ...
            <td bgcolor="#ffffff" class="mainContentRightTd" style="height: 20px">
                <asp:DropDownList ID="ddlInterface" runat="server">
                    ...
                    <asp:ListItem Value="3">财富通</asp:ListItem>
      ...
      <tr>
        <td bgcolor="#FFFFFF" colspan="2" >
            <FCKeditorV2:FCKeditor ID="PaymentContent" runat="server" Height="250px" Width="100%"></FCKeditorV2:FCKeditor></td>
      </tr>

      <tr>
        <td align="right" bgcolor="#FFFFFF"></td>
        <td bgcolor="#FFFFFF">&nbsp;<asp:Button ID="UpDate" runat="server" Text="更新支付" CssClass="inputBt" OnClick="UpDate_Click" /></td>
      </tr>
    </table>
  </div>
