...
//上传图片
function WBTB_uploadImage(size)
{
/*
	var arr = showModalDialog("wbTextBox/UploadImgDlg.aspx?size="+size, "", "dialogWidth:25em; dialogHeight:13em; status:0; help:0");
	if(arr=="")
			return;
	...
	WBTB_Composition.document.body.innerHTML+=arr;
	*/
	
	 var arr = showModalDialog("/admin/wbTextBox/UploadImgDlg.aspx?size="+2000000, "", "dialogWidth:25em; dialogHeight:25em; status:0; help:0");
	        if(arr=="")
			    return false;
	
	        if(arr==undefined)
			    return false;
	        arr="<IMG SRC=\"/upload/"+arr+"\" />";
            
           var content=WBTB_Composition.document.body.innerHTML;
		    content=content+arr;
...
//URL图片
function WBTB_UrlImage()
{
    var arr = showModalDialog("/admin/wbTextBox/UrlImg.htm", "", "dialogWidth:25em; dialogHeight:13em; status:0; help:0");
	if(arr=="")
			return;
...
{
	if (!WBTB_validateMode()) return;
	var arr = showModalDialog("/admin/wbTextBox/selcolor.html", "", "dialogWidth:18.5em; dialogHeight:17.5em; status:0; help:0");
...
{
	if (!WBTB_validateMode())	return;
	var arr = showModalDialog("/admin/wbTextBox/table.html", "", "dialogWidth:14.5em; dialogHeight:16.5em; status:0; help:0");
...
function WBTB_forswf()
{
	...
	var arr = showModalDialog("/admin/wbTextBox/InsertFlashDlg.aspx?size="+2000000, "", "dialogWidth:20em; dialogHeight:15em; status:0; help:0");
	if (arr != null){
		var ss;
		ss=arr.split("*")
		path=ss[0];
		...
		col=ss[2];
		var string;
		string="<div align='center'><object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'  codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0' width="+row+" height="+col+"><param name=movie value=\"/upload/"+path+"\"><param name=quality value=high><embed src=\"/upload/"+path+"\" pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' type='application/x-shockwave-flash' width="+row+" height="+col+"></embed></object>"
		content=WBTB_Composition.document.body.innerHTML;
		content=content+string;
		WBTB_Composition.document.body.innerHTML=content;
	}
...
function WBTB_forwmv()
{
	...
	var arr = showModalDialog("/admin/wbTextBox/InsertWMVDlg.aspx?size="+2000000, "", "dialogWidth:15.5em; dialogHeight:14em; status:0; help:0");
	...
	if (arr != null){
		...
		string="<embed src='/upload/"+ path+"' width="+ width +" height="+ height +" autostart=true loop=false ></embed>";
		content=WBTB_Composition.document.body.innerHTML;
		content=content+string;
		WBTB_Composition.document.body.innerHTML=content;
	}
...
function WBTB_forrm()
{
	var arr = showModalDialog("/admin/wbTextBox/rm.htm", "", "dialogWidth:15.5em; dialogHeight:14em; status:0; help:0");
	...
	if (arr != null)
	{
		...
		col=ss[2];
		var string;
		string="<object classid='clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA' width="+row+" height="+col+"><param name='CONTROLS' value='ImageWindow'><param name='CONSOLE' value='Clip1'><param name='AUTOSTART' value='-1'><param name=src value='/upload/"+path+"'></object><br><object classid='clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA'  width="+row+" height=60><param name='CONTROLS' value='ControlPanel,StatusBar'><param name='CONSOLE' value='Clip1'></object>";
		content=WBTB_Composition.document.body.innerHTML;
		content=content+string;
		WBTB_Composition.document.body.innerHTML=content;
	}
...
{
	var arr = showModalDialog("/admin/wbTextBox/replace.html", "", "dialogWidth:16.5em; dialogHeight:13em; status:0; help:0");
...
function WBTB_help()
{
	showModalDialog("/admin/wbTextBox/help.html", "", "dialogWidth:13.5em; dialogHeight:12.5em; status:0; help:0");
}