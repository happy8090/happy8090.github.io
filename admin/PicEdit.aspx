<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="PicEdit.aspx.cs" Inherits="WangQi.ERP.Web.admin.PicEdit" Title="无标题页" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7">
      <tr>
        <td colspan="2" bgcolor="#FFFFFF" class="mainTitle">
            "<asp:Label ID="MenuName" runat="server" ForeColor="Black"></asp:Label>" 编辑图文&nbsp;</td>
      </tr>
      <tr>
        <td align="right" bgcolor="#FFFFFF" >
            图文ID:</td>
        <td bgcolor="#FFFFFF" >
            <asp:Label ID="ShowPicId" runat="server" ForeColor="Red"></asp:Label>
        </td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="mainContentRightTd">
            <asp:DropDownList ID="PicClassIdList" runat="server">
            </asp:DropDownList>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" >
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="PicTitle"
                Display="Dynamic" ErrorMessage="图文标题必须填写"></asp:RequiredFieldValidator></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FFFFFF" style="height: 20px">&nbsp;<asp:FileUpload ID="PicSmall" runat="server" />&nbsp;
            ...
            不修改留空</span> 引用路径：<asp:TextBox ID="TB_UrlSmall" runat="server"></asp:TextBox></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FFFFFF">&nbsp;<asp:FileUpload ID="PicBig" runat="server" />&nbsp;
            ...
            不修改留空</span>        引用路径：<asp:TextBox ID="TB_UrlBig" runat="server"></asp:TextBox></td>
      </tr>
      ...
      <tr>
        <td colspan="2" align="left"  bgcolor="#ffffff" >
            ...
            <tr>
        <td align="right" bgcolor="#FFFFFF" >内容摘要:</td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" style="height: 20px">&nbsp;<asp:Button ID="Edit" runat="server" Text="编辑图文" CssClass="inputBt" OnClick="Edit_Click"  /></td>
      </tr>
    </table>
  </div>
