<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="DeliveryEdit.aspx.cs" Inherits="WangQi.ERP.Web.admin.DeliveryEdit" Title="无标题页" %>
  ...
  <div id="mainMenu">
   ...
   <asp:Label id="Msg" runat="server" Text="" CssClass="msg" Visible="False"></asp:Label>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7">
      ...
      <tr>
        <td align="right" bgcolor="#FFFFFF" class="mainContentLeftTd" style="height: 19px" >
            运送方式名称:</td>
        <td bgcolor="#FFFFFF"  class="mainContentRightTd" style="height: 19px" >
      ...
      <tr>
            ...
            <td bgcolor="#ffffff" class="mainContentRightTd">
                <asp:DropDownList ID="ddlInterface" runat="server">
                    <asp:ListItem Selected="True" Value="0">请选择运送接口</asp:ListItem>
      ...
      <tr>
        <td bgcolor="#FFFFFF" colspan="2" style="height: 27px" >
            <FCKeditorV2:FCKeditor ID="DeliveryContent" runat="server" Height="250px" Width="100%"></FCKeditorV2:FCKeditor></td>
      </tr>

      <tr>
        <td align="right" bgcolor="#FFFFFF"></td>
        <td bgcolor="#FFFFFF">&nbsp;<asp:Button ID="UpDate" runat="server" Text="更新运送" CssClass="inputBt" OnClick="UpDate_Click" /></td>
      </tr>
    </table>
  </div>
