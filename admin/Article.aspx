<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true"  ValidateRequest ="false" CodeBehind="Article.aspx.cs" Inherits="WangQi.ERP.Web.admin.Article" Title="无标题页"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
  ...
  <div id="mainMenu">
  	<ul>
		<li><a href="#">添加文章</a></li><li><a href="ArticleList.aspx<%=Request.Params["op"] == null ? "" : "?op=Hidden" %>">管理文章</a></li><li><a href="ArticleEdit.aspx<%=Request.Params["op"] == null ? "" : "?op=Hidden" %>">编辑文章</a></li><li><a href="ArticleClass.aspx<%=Request.Params["op"] == null ? "" : "?op=Hidden" %>">分类管理</a></li></ul>
  </div>
   <div id="main">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7">
      <tr>
        <td colspan="2" bgcolor="#FFFFFF" class="mainTitle">
            "<asp:Label ID="MenuName" runat="server" ForeColor="Black"></asp:Label>"添加文章&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" bgcolor="#FFFFFF" >
            文章标题:</td>
        <td bgcolor="#FFFFFF" >
            <asp:TextBox ID="ArticleTitle" CssClass="adminput" runat="server"></asp:TextBox>
      ...
      <tr>
        <td colspan="2" align="left"  bgcolor="#ffffff" >
            ...
            <tr>
        <td align="right" bgcolor="#FFFFFF" style="height: 46px" >
            文章简介:</td>
      ...
      <tr>
        <td align="right" bgcolor="#FFFFFF" >
            添加时间:</td>
        <td bgcolor="#FFFFFF">
            <asp:TextBox ID="AddTime" runat="server" MaxLength ="25"></asp:TextBox>
...
<script type="text/javascript">
  ...
  <script language="JavaScript" type="text/javascript" >
       ...
       else
       {
        ...
        contentMenuThisPage();//当前位置左侧菜单标识
