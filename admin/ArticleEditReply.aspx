<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true"  ValidateRequest ="false" CodeBehind="ArticleEditReply.aspx.cs" Inherits="WangQi.ERP.Web.admin.ArticleEditReply" Title="无标题页"  %>
