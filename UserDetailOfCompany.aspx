<%@ Page Language="C#" MasterPageFile="~/Master/Default/Page.master" AutoEventWireup="true" CodeBehind="UserDetailOfCompany.aspx.cs" Inherits="WangQi.ERP.Web.UserDetailOfCompany" Title="无标题页" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="siteMapPath" >
        <asp:Literal ID="SiteMapPath" runat="server" Text="" >s</asp:Literal>
    </div>
    <div class="mframe">
        <div class="tl"></div>
        <div class="tr"></div>
        ...
        <div class="pack">
            ...
            <div class="mm f14">
                ...
                <table width="100%" cellpadding="6" cellspacing="0" border="0">
                    ...
                    <tr valign="top">
                        <td align="right"><asp:Literal ID="LiteralDetail" meta:resourcekey="LiteralDetail" runat="server"></asp:Literal></td>
                        <td><asp:TextBox ID="txtDesc" runat="server" TextMode="MultiLine" CssClass="inputbg" Width="300px" Height="200px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td align="right"></td>
                        <td><asp:Button ID="btnSave" meta:resourcekey="btnSave" runat="server" CssClass="btn" OnClick="btnSave_Click" Text="" /></td>
                    </tr>
                </table>
            </div>
        </div>
