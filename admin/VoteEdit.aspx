<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="VoteEdit.aspx.cs" Inherits="WangQi.ERP.Web.admin.VoteEdit" Title="无标题页" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7">
      ...
      <tr>
        <td align="right" bgcolor="#FFFFFF" >
            投票ID:</td>
        <td bgcolor="#FFFFFF" >
            <asp:Label ID="ShowVoteId" runat="server" ForeColor="Red"></asp:Label>
        </td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FFFFFF">
           <asp:TextBox ID="ValueStr" runat="server" Rows="5" TextMode="MultiLine" CssClass="adminbox"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ValueStr"
                        Display="Dynamic" ErrorMessage="票数必须填写<br />"></asp:RequiredFieldValidator>
        </td>
      </tr>
      <tr>
            <td align="right" bgcolor="#ffffff">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" style="height: 20px">&nbsp;<asp:Button ID="Edit" runat="server" Text="编辑投票" CssClass="inputBt" OnClick="Edit_Click"  /></td>
      </tr>
    </table>
  </div>
