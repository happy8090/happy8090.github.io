<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="MemberGroup.aspx.cs" Inherits="WangQi.ERP.Web.admin.MemberGroup" Title="无标题页" %>
...
<div id="mainMenu">
  ...
  <div id="main">
      ...
      <table id="Table1" bgcolor="#d7d7d7" border="0" cellpadding="2" cellspacing="1" width="100%">
          <tr>
              <td bgcolor="#ffffff" class="mainTitle" colspan="3" style="height: 20px">
                  所属部门操作</td>
          </tr>
          <tr>
              <td bgcolor="#ffffff" colspan="3" style="height: 27px">
        <asp:GridView ID="gvGroup" runat="server" AutoGenerateColumns="False" DataKeyNames ="Id" OnRowCancelingEdit="gvGroup_RowCancelingEdit" OnRowEditing="gvGroup_RowEditing" OnRowUpdating="gvGroup_RowUpdating" EmptyDataText="暂无任何所属部门" Width="100%" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="组名">
                    <EditItemTemplate>
                        <asp:TextBox ID="gvtbName" runat="server" Text='<%# Bind("GroupName") %>'></asp:TextBox>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="gvtbName" runat="server" Text='<%# Bind("GroupName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="删除">
                  ...
                  <asp:HiddenField ID="HiddenField1" runat="server" />  
                      <br />        <asp:Button ID="btnAll" runat="server" Text="全选" CausesValidation ="false"  OnClick="btnAll_Click" />
      ...
      <tr>
          ...
          <td bgcolor="#FFFFFF" style="height: 27px">&nbsp;
              ...
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*必填" ControlToValidate ="tbName" ValidationGroup ="1"></asp:RequiredFieldValidator></td>
          <td bgcolor="#ffffff" style="height: 27px">
