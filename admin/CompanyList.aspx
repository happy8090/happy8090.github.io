<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="CompanyList.aspx.cs" Inherits="WangQi.ERP.Web.admin.CompanyList" Title="无标题页" %>
  ...
  <div id="mainMenu">
   ...
   <asp:Label id="Msg" runat="server" Text="" CssClass="msg" Visible="False"></asp:Label>
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7" id="mainTopTable">
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF" class="mainTitle">
            所属部门：<asp:DropDownList ID="DDlMemberGroup" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDlMemberGroup_SelectedIndexChanged"
                Width="120px">
            </asp:DropDownList></td>
      </tr>
      <tr>
   ...
   <asp:GridView ID="gvMemberList" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="MemberList_PageIndexChanging" DataKeyNames="MemberId" OnRowCancelingEdit="MemberList_RowCancelingEdit" OnRowEditing="MemberList_RowEditing" OnRowUpdating="MemberList_RowUpdating" PageSize="11"  CellPadding="0" CssClass="gv" Width="100%" EmptyDataText="暂无任何人员" >
        <Columns>
            ...
            <asp:TemplateField HeaderText="当前">
                <ItemTemplate>
                <%# CurrentState(Eval("MemberId"))%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="本月">
                <ItemTemplate>
                   <a href='CompanyMonth.aspx?MemberID=<%#Eval("MemberId") %>&op=Month'>查看</a>
                </ItemTemplate>
            </asp:TemplateField>
...
<br />
    ...
    <asp:Button ID="btnCompay" runat="server" OnClick="btnCompay_Click" Text="取消人员" />
