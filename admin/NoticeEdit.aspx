<%@ Page Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="NoticeEdit.aspx.cs" Inherits="WangQi.ERP.Web.admin.NoticeEdit" Title="无标题页" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D7D7D7">
     ...
     <tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" style="height: 20px">&nbsp;<asp:Button ID="Edit" runat="server" Text="编辑公告" CssClass="inputBt" OnClick="Edit_Click"  /></td>
      </tr>
    </table>
  </div>
